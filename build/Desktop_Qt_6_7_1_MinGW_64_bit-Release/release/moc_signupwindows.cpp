...
#include "../../../../Messaging APp/signupwindows.h"
...
struct qt_meta_stringdata_CLASSSignUpWindowsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSignUpWindowsENDCLASS = QtMocHelpers::stringData(
    "SignUpWindows",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSignUpWindowsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SignUpWindows::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_CLASSSignUpWindowsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSignUpWindowsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSignUpWindowsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SignUpWindows, std::true_type>,
...
void *SignUpWindows::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSignUpWindowsENDCLASS.stringdata0))
